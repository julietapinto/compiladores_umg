...
class ExpresionesVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ExpresionesParser#switchStmt.
    def visitSwitchStmt(self, ctx:ExpresionesParser.SwitchStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ExpresionesParser#caseStmt.
    def visitCaseStmt(self, ctx:ExpresionesParser.CaseStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ExpresionesParser#defaultStmt.
    def visitDefaultStmt(self, ctx:ExpresionesParser.DefaultStmtContext):
        return self.visitChildren(ctx)
